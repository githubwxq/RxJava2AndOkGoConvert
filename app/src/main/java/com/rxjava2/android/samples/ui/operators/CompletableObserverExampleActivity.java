...
public class CompletableObserverExampleActivity extends AppCompatActivity {
    ...
    private void doSomeWork() {
        ...
        Completable completable12=Completable.timer(1000,TimeUnit.SECONDS);

        completable12.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new CompletableObserver() {
            @Override
            ...
            public void onComplete() {
                ...
                Toast.makeText(CompletableObserverExampleActivity.this, "王城數據玩", Toast.LENGTH_SHORT).show();
            }

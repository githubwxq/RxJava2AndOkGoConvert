...
public class MapExampleActivity extends AppCompatActivity {
    ...
    */
    private void doSomeWork() {
        ...
        Observable.create(new ObservableOnSubscribe<List<String>>() {
        ...
        }).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).map(new Function<List<String>, List<String>>() {
            ...
            public void accept(@NonNull List<String> list) throws Exception {
                for (int i = 0; i < list.size(); i++) {
                    Toast.makeText(MapExampleActivity.this, list.get(i).toString(), Toast.LENGTH_SHORT).show();
                }
            }
        });
